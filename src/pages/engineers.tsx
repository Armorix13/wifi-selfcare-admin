                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                          ...
                          <Select 
                            ...
                            onValueChange={(value) => form.setValue("specialization", value as "Network" | "Hardware" | "Software" | "Installation" | "Maintenance")}
                          >
                            <SelectTrigger>
          ...
          <div className="grid grid-cols-2 gap-4 py-4">
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value) => editForm.setValue("specialization", value as "Network" | "Hardware" | "Software" | "Installation" | "Maintenance")}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select specialization" />
                </SelectTrigger>
